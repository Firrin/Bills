...
<html lang="en">
  <head>
    <title>Bill's Coffee - Gallery</title>
    <!-- meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Bill's Coffee - Galleri. See photos from our cafe and Instagram. Touch the pictures to get to our Instagram">
    <!-- favicon  -->
...
<li class="nav-item">
<a href="../galleri.php" class="nav-link">Danish <i class="fa fa-globe"> </i></a>
</li>
</ul>
</div>
</nav>
...
<div class="container-fluid text-center">
  ...
  <p class="text-muted">Touch the pictures to get to our Instagram</p>
  </div>
