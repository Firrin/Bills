...
<html lang="en">
  <head>
    <title>Bill's Coffee - Menucard</title>
    <!-- meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Bill's Coffee - Aarhus coffee shop in Vestergade. Here you will find our menucard, see what we offer of coffee, drink and cake.">
    <!-- favicon  -->
...
<li class="nav-item">
<a href="../menukort.php" class="nav-link">Danish <i class="fa fa-globe"> </i></a>
</li>
</ul>
</div>
</nav>
...
<!-- Menukort starter her  -->
<section>
  <h1 class="text-center title-menu pt-5">Coffee</h1>
  <div class="menu-underline"></div>
  <div class="row">
      <div class="col-lg-6 col-md-12 col-sm-12 padding-menu-right">
    <div class="menu-item">
  <div class="menu-item-name">Espresso</div>
  <div class="menu-item-price"> 25,-</div>
  </div>
    <div class="menu-item">
  <div class="menu-item-name">Black (filter)</div>
  <div class="menu-item-price"> 20/25,-</div>
  </div>
    <div class="menu-item">
  ...
  <div class="menu-item">
  <div class="menu-item-name">Caffe Latte</div>
  <div class="menu-item-price"> 41,-</div>
  </div>
  </div>
  <div class="col-lg-6 col-md-12 col-sm-12 padding-menu-left">
  <div class="menu-item">
  <div class="menu-item-name">Americano</div>
  <div class="menu-item-price"> 25,-</div>
  </div>
  <div class="menu-item">
  <div class="menu-item-name">Black (Hand-crafted)</div>
  ...
  <div class="menu-item">
  <div class="menu-item-name">Bill's Latte</div>
  <div class="menu-item-price"> 39,-</div>
  </div>
  <div class="menu-item">
...
<div class="drinks-menu"></div>
  <h1 class="text-center title-menu pt-5">Other Drinks</h1>
  <div class="menu-underline"></div>
  <div class="row">
    <div class="col-lg-6 col-md-12 col-sm-12 padding-menu-right pb-5">
      <div class="menu-item">
    <div class="menu-item-name">Tea</div>
    <div class="menu-item-price"> 35,-</div>
    </div>
    <div class="menu-item">
  ...
  <div class="menu-item-price"> 41,-</div>
      ...
      <div class="menu-item">
    <div class="menu-item-name">Frappuchino</div>
    <div class="menu-item-price"> 41,-</div>
    </div>
    </div>
    <div class="col-lg-6 col-md-12 col-sm-12 padding-menu-left">
      <div class="menu-item">
    <div class="menu-item-name">Organic Chai Latte</div>
    <div class="menu-item-price"> 25,-</div>
    </div>
      <div class="menu-item">
    <div class="menu-item-name">Mocca</div>
...
<div class="food-menu"></div>
  <h1 class="text-center title-menu pt-5">Desserts</h1>
  <div class="menu-underline"></div>
...
<div class="menu-item-price"> 15,-</div>
  ...
  <div class="menu-item">
<div class="menu-item-name">Bun</div>
<div class="menu-item-price"> 25,-</div>
</div>
  <div class="menu-item">
<div class="menu-item-name">Yogurt</div>
<div class="menu-item-price"> 20,-</div>
</div>
<div class="menu-item">
<div class="menu-item-name">Cake</div>
<div class="menu-item-price"> 15/25,-</div>
    </div>
      </div>
<div class="col-lg-6 col-md-12 col-sm-12 padding-menu-left">
<div class="menu-item">
<div class="menu-item-name">Rye bread</div>
<div class="menu-item-price"> 15,-</div>
</div>
<div class="menu-item">
<div class="menu-item-name">Cheese / Butter / Jam</div>
<div class="menu-item-price"> 10,-</div>
</div>
<div class="menu-item">
<div class="menu-item-name">Yogurt with muesli</div>
<div class="menu-item-price"> 25,-</div>
</div>
</div>
</div>
